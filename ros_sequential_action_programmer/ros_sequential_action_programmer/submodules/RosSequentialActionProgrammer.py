...
from rsap_interfaces.msg import RsapTick
...
class RosSequentialActionProgrammer:
    ...
    def execute_current_action(self, log_mode: int = ExecutionLog.LOG_NEVER, shift_action:bool = False) -> bool:
        ...
        try:
            ...
            self._send_tick(current_action, is_start=True)
            ...
            self._send_tick(current_action, is_start=False, success=success_exec)
    ...
    def _send_tick(self, action: ActionBaseClass, 
        ...
        if success is not None:
            ...
            tick_msg.success = True
        self._tick_publisher.publish(tick_msg)
